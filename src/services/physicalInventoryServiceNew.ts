...
class PhysicalInventoryService {
  ...
  async updatePhysicalInventory(id: string, data: Partial<PhysicalInventoryType>): Promise<PhysicalInventoryType> {
  ...
  async approvePhysicalInventory(id: string): Promise<PhysicalInventoryType> {
