...
const AccountsHome: React.FC = () => {
  ...
  const accountCards = [
    ...
    },
    {
      ...
      icon: Link,
      href: '/app-accounts/linked-accounts'
    },
    {
      id: 'opening-balances',
  ...
  return (
    <div className="content-container">
      <div className="space-y-6">
        {/* Page Header */}
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Accounts Home</h1>
          <p className="text-gray-600 mt-1">Financial accounting and ledger management system</p>
        </div>
