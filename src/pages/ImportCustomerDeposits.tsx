...
import { useImportCustomerDeposits } from '../hooks/useImportCustomerDeposits';
...
const ImportCustomerDeposits: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Import Customer Deposits</h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          ...
          <p className="text-gray-600 mb-4">
            Download the Excel template with existing customer codes and names, plus other required fields for importing customer deposits.
          </p>
          <Button
        ...
        <Card className="p-6">
          ...
          <p className="text-gray-600 mb-4">
            Select your filled Excel file to upload and validate the customer deposit data.
          </p>
        ...
        <Card className="mt-6 p-6">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900">
              {isUploading ? 'Uploading File...' : 'Importing Customer Deposits...'}
            </h3>
          </div>
        ...
        <Card className="mt-6 p-6">
          ...
          {errors.length === 0 && success && (
            <Button
              ...
              variant="primary"
            >
              {isImporting ? 'Importing...' : 'Import Valid Customer Deposits'}
            </Button>
          )}
        </Card>
      )}
      ...
      <Card className="mt-6 p-6">
        ...
        <div className="space-y-3 text-sm text-gray-600">
          <div className="flex items-start">
            ...
            <span>Download the Excel template using the button above (includes existing customer codes and names)</span>
          </div>
          <div className="flex items-start">
            ...
            <span>Fill in your customer deposit data following the template structure</span>
          </div>
          <div className="flex items-start">
          ...
          <div className="flex items-start">
            ...
            <span>Click "Import Valid Customer Deposits" to complete the import</span>
          </div>
        </div>
      </Card>
    </div>
...
export default ImportCustomerDeposits;
