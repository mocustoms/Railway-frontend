      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          ...
          <p className="text-gray-600 mb-4">
            Download the Excel template with the correct column structure for importing products.
          </p>
          <Button
        ...
        <Card className="p-6">
          ...
          <p className="text-gray-600 mb-4">
            Select your filled Excel file to upload and validate the data.
          </p>
        ...
        <Card className="mt-6 p-6">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900">
              {isUploading ? 'Uploading File...' : 'Importing Products...'}
            </h3>
          </div>
        ...
        <Card className="mt-6 p-6">
          ...
          {errors.length === 0 && success && (
            <Button
              ...
              variant="primary"
            >
              {isImporting ? 'Importing...' : 'Import Valid Products'}
            </Button>
          )}
        </Card>
      )}
      ...
      <Card className="mt-6 p-6">
        ...
        <div className="space-y-3 text-sm text-gray-600">
          ...
          <div className="flex items-start">
            ...
            <span>Fill in your product data following the template structure</span>
          </div>
          <div className="flex items-start">
          ...
          <div className="flex items-start">
            ...
            <span>Click "Import Valid Products" to complete the import</span>
          </div>
        </div>
      </Card>
    </div>
