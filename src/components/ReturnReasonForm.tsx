...
import { returnTypeConfig } from '../data/returnReasonModules';
import { useAccounts } from '../hooks/useAccounts';
import Button from './Button';
import './ReturnReasonForm.css';
...
const ReturnReasonForm: React.FC<ReturnReasonFormProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="return-reason-form">
      ...
      <div className="form-actions">
        ...
        <Button
          ...
          disabled={isLoading || isSubmitting}
        >
          {returnReason ? 'Update' : 'Create'} Return Reason
        </Button>
      </div>
    </form>
  );
