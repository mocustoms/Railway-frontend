...
interface ProformaInvoiceReopenModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const ProformaInvoiceReopenModal: React.FC<ProformaInvoiceReopenModalProps> = ({
  isOpen,
  onClose,
  proformaInvoice,
  onConfirm,
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-medium text-red-600">
                  {proformaInvoice.validUntil || 'Not set'}
                </span>
              </div>
            </div>
          </div>
...
export default ProformaInvoiceReopenModal;
