...
import './ReturnsOutReasonView.css';

interface ReturnsOutReasonViewProps {
  returnReason: ReturnReason;
  onEdit?: () => void;
}

const ReturnsOutReasonView: React.FC<ReturnsOutReasonViewProps> = ({
  returnReason,
  onEdit
}) => {
  ...
  return (
    <div className="returns-out-reason-view">
      <div className="view-header">
        <h3 className="view-title">Returns Out Reason Details</h3>
        {onEdit && (
...
export default ReturnsOutReasonView;
