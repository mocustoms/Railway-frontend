...
interface PurchasingOrderRejectionModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const PurchasingOrderRejectionModal: React.FC<PurchasingOrderRejectionModalProps> = ({
  isOpen,
  onClose,
  purchasingOrder,
  onConfirm,
        ...
        <div className="flex items-center space-x-3 p-4 rounded-lg bg-red-50 border border-red-200">
          ...
          <div>
            <h3 className="text-lg font-semibold text-red-800">
              Reject Purchasing Order
            </h3>
            <p className="text-sm text-red-600">
              This will reject the purchasing order. Please provide a reason.
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-medium">
                  {purchasingOrder.currencySymbol || ''}{purchasingOrder.totalAmount?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) || '0.00'}
                </span>
              </div>
            </div>
          </div>
...
export default PurchasingOrderRejectionModal;
