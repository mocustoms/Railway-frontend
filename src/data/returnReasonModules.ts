...
export interface ReturnReasonModule {
  id: string;
  title: string;
  description: string;
...
export const RETURN_REASON_MODULE: ReturnReasonModule = {
  id: 'return-reasons',
  ...
  category: 'sales',
  tags: ['returns', 'refunds', 'exchanges', 'sales', 'management'],
  color: '#f59e0b',
  gradient: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)',
  features: ['Return reason management', 'Refund tracking', 'Approval workflows', 'Account integration'],
  priority: 'high',
  status: 'active',
  isRequired: true
};
...
export const RETURN_REASON_COLUMNS = [
